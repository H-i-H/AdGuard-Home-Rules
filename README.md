...
📊 **规则总数**：<!-- RULES_COUNT --> 702073 条
🕒 **最后更新**：<!-- LAST_UPDATE --> 2026-07-01 07:04:30

这是一个由 Ai 编写的为 AdGuard Home 设计的过滤规则仓库，仅用于测试，如有违规，请联系作者删除。该仓库具有以下特点：

- **自动化更新**：每 12 小时自动更新规则（仅当上游源文件内容发生变化时）
- **分类管理**：广告、恶意网站、成人内容分门别类
- **白名单机制**：每个类别都有白名单，减少误拦截
- **轻量精简**：基于高质量规则源，深度去重，避免臃肿

## 使用方法

直接使用：在 AdGuard Home 的“过滤器” -> “DNS 封锁清单”中添加以下规则订阅链接。
