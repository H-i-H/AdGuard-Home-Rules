...
黑名单（非通用格式）
```
https://raw.githubusercontent.com/qirui-bot/AdGuard-Home-Rules/main/Release/special-rules.txt
```
白名单
```
https://raw.githubusercontent.com/qirui-bot/AdGuard-Home-Rules/main/Release/combined-whitelist.txt
```
