...
黑名单
```
https://raw.githubusercontent.com/qirui-bot/AdGuard-Home-Rules/refs/heads/main/Release/combined-rules.txt
```
黑名单（非通用格式）
```
https://raw.githubusercontent.com/qirui-bot/AdGuard-Home-Rules/refs/heads/main/Release/special-rules.txt
```
白名单
```
https://raw.githubusercontent.com/qirui-bot/AdGuard-Home-Rules/refs/heads/main/Release/combined-whitelist.txt
```
